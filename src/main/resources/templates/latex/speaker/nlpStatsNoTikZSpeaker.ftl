...
\subsection*{NLP-Analyse der Rede}
...
\subsubsection*{Top ${topTopics?size} Topics}
...
\subsubsection*{Top ${topEntities?size} Named Entities}
...
\subsubsection*{Top ${topPos?size} POS-Typen}
