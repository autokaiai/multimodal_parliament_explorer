...
Any use, reuse, or distribution must credit **all four team members** (Philipp Hein, Philipp Landmann, Philipp Schneider, and Kai Alois Wöllstein). The full license and copyright notice from the [`LICENSE`](LICENSE) file must be retained.
