...
<export type="speech">
    ...
    <#if speech.agenda??>
        <agenda>
            <#if speech.agenda.id??>
                <id>${speech.agenda.id}</id>
            </#if>
            <#if speech.agenda.title??>
                <title>${speech.agenda.title}</title>
            </#if>
            <#if speech.agenda.index??>
                <index>${speech.agenda.index}</index>
            </#if>
        </agenda>
    </#if>
    ...
    <#if speech.protocol??>
        <protocol>
            <#if speech.protocol.title??>
                <title>${speech.protocol.title}</title>
            </#if>
            <#if speech.protocol.date??>
                <date>${speech.protocol.date}</date>
            </#if>
            <#if speech.protocol.wp??>
                <wp>${speech.protocol.wp}</wp>
            </#if>
            <#if speech.protocol.index??>
                <index>${speech.protocol.index}</index>
            </#if>
            <#if speech.protocol.place??>
                <place>${speech.protocol.place}</place>
            </#if>
        </protocol>
    </#if>
